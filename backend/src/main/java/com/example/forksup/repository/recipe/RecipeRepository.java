...
@Repository
public interface RecipeRepository extends MongoRepository<Recipe, ObjectId>, RecipeRepositoryCustom {

    @Query("{ $text: { $search: ?0 } }")
    List<Recipe> findByName(String keyword, Pageable pageable);
